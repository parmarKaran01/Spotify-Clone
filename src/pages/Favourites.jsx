...
import { Songs, formatTime } from "../components/helper";
import {
  Avatar,
  List,
  ListItem,
...
export default function Favourites() {
  ...
  return (
    <motion.div
      className="w-full h-full flex flex-col px-2 py-6 min-w-[300px] overflow-hidden"
    ...
    >
      ...
      <div className="mt-4">
        {loading ? (
          ...
          <List className="w-full overflow-y-auto md:h-full">
            {data &&
